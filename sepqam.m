...
sepexact = 4*kqam*I1exact - 4*kqam^2*I2exact;
...
sepkara = 4*kqam*I1kara - 4*kqam^2*I2kara;
sepprony2 = 4*kqam*I1Prony2 - 4*kqam^2*I2Prony2;
sepprony3 = 4*kqam*I1Prony3 - 4*kqam^2*I2Prony3;
sepolab1= 4*kqam*I1Olab1 - 4*kqam^2*I2Olab1;
sepolab2 = 4*kqam*I1Olab2 - 4*kqam^2*I2Olab2;
sepolab3 = 4*kqam*I1Olab3 - 4*kqam^2*I2Olab3;
sepgh = 4*kqam*I1gh - 4*kqam^2*I2gh;
sepchiani = 4*kqam*I1Chiani - 4*kqam^2*I2Chiani;
sepmbfc1 = 4*kqam*I1mbfc1 - 4*kqam^2*I2mbfc1;
sepmbfc2  = 4*kqam*I1mbfc2 - 4*kqam^2*I2mbfc2;
sepampj = 4*kqam*I1ampj - 4*kqam^2*I2ampj;
sepsya3 = 4*kqam*I1SYA3 - 4*kqam^2*I2SYA3;
sepsya4 = 4*kqam*I1SYA4 - 4*kqam^2*I2SYA4;
