...
k = 4;
I4kara = zeros(1,nTerms);

for i = 0:k
    I4kara = I4kara + (-1)^i*nchoosek(k,i)*((k*a^2/2+m./gb).^(-m+k/2-1/2).*(sqrt(k*a^2/2+m./gb)*gamma(m-k/2).*hypergeom(m-k/2,1/2,1.98^2*a^2*i^2./(8*(k*a^2/2+m./gb))) - i*1.98*a/sqrt(2)*gamma(m-k/2+1/2)*hypergeom(m-k/2+1/2,3/2,i^2*1.98^2*a^2./(8*(k*a^2/2+m./gb)))));
end

I4kara = const/(1.135*a*sqrt(2*pi))^k.*I4kara;

sepkara = 4*I1kara -8*I2kara +8*I3kara - 4*I4kara;
...
% I1mbfc2 = const*exp(-1.1893).*(m./gb+0.984*a^2/2).^(-1/2-m).*(sqrt(m./gb+0.984*a^2/2).*gamma(m).*hypergeom(m,1/2,0.4803^2*a^2./(8*(m./gb+0.984*a^2/2)))-0.4803*a/sqrt(2)*gamma(m+1/2).*hypergeom(m+1/2,3/2,0.4803^2*a^2./(8*(m./gb+0.984*a^2/2))));
% 
% k=2;
% I2mbfc2 = const*exp(-k*1.1893).*(m./gb+0.984*(a^2*k)/2).^(-1/2-m).*(sqrt(m./gb+0.984*(a^2*k)/2).*gamma(m).*hypergeom(m,1/2,0.4803^2*(a*k)^2./(8*(m./gb+0.984*(a^2*k)/2)))-0.4803*(a*k)/sqrt(2)*gamma(m+1/2).*hypergeom(m+1/2,3/2,0.4803^2*(a*k)^2./(8*(m./gb+0.984*(a^2*k)/2))));
% 
% k=3;
% I3mbfc2 = const*exp(-k*1.1893).*(m./gb+0.984*(a^2*k)/2).^(-1/2-m).*(sqrt(m./gb+0.984*(a^2*k)/2).*gamma(m).*hypergeom(m,1/2,0.4803^2*(a*k)^2./(8*(m./gb+0.984*(a^2*k)/2)))-0.4803*(a*k)/sqrt(2)*gamma(m+1/2).*hypergeom(m+1/2,3/2,0.4803^2*(a*k)^2./(8*(m./gb+0.984*(a^2*k)/2))));
% 
% k=4;
% I4mbfc2 = const*exp(-k*1.1893).*(m./gb+0.984*(a^2*k)/2).^(-1/2-m).*(sqrt(m./gb+0.984*(a^2*k)/2).*gamma(m).*hypergeom(m,1/2,0.4803^2*(a*k)^2./(8*(m./gb+0.984*(a^2*k)/2)))-0.4803*(a*k)/sqrt(2)*gamma(m+1/2).*hypergeom(m+1/2,3/2,0.4803^2*(a*k)^2./(8*(m./gb+0.984*(a^2*k)/2))));
